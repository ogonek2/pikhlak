    ...
    public function run(): void
    {
        ...
        $routes = [
            ...
            [
                ...
                'intent_keywords' => ['расчёт', 'калькулятор', 'стоимость достав', 'растамож', 'под ключ'],
                'model_id' => $groq?->id,
                'data_sources' => ['faq', 'leads'],
                'extra_instruction' => 'Не называй точную цену без данных. Предложи менеджера или уточни город/марку/год.',
                'priority' => 70,
            ],
            [
                'slug' => 'not_leasing',
